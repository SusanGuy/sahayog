...
const Home = ({ history: { location: { pathname } } }) => {
    ...
    return (
        <div className='Home'>
            {<Hamburger hamburger={hamburger} handleBurger={sethamburger} route={pathname} />}
            {
                <Nav
                    scroll={scrolled}
                    hamburger={() => {
                        ...
                        <div key={h.title} className='fcard'>
                            ...
                            <div className='bottom'>
                                ...
                                <div className='raised-text'>
                                    ...
                                    <span>{`${h.raised} (${Math.floor(h.raised * 100 / h.goal)}%)`}</span>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <Button position='fixed' bottom='1rem' width='50%' right='1rem'>
