...
const Donate = ({ target }) => {
    ...
    return (
        <div className='Donate'>
            <div className='donation-fill' style={{ width: `${donation / target * 100}%` }} />
            <div className='slider-before'>
                ...
                <div className='donate-title'>
                    ...
                    </h1>
                    {
                        // <h1>
                        //     $
                        //     <FlipNumbers height={17} width={15} play perspective={100} numbers={donation.toString()} />
                        // </h1>
                    }
            ...
            <SliderWrapper target={target} donation={donation} changeDonation={handleDonation} />
...
const SliderWrapper = ({ target, donation, changeDonation }) => {
    return (
        <div className='slider-wrapper'>
            <input className='slider' type='range' min='0' max={target} onChange={changeDonation} value={donation} />
