...
const menus = {
    ...
    DONATION: { icon: <Icons.Plus />, title: 'My Donations', link: '/my-donations' },
    CONTRIBUTION: { icon: <Icons.Smile />, title: 'My Fundraisers', link: '/my-fundraisers' },
...
const Hamburger = ({ hamburger, handleBurger, route = menus.HOME.title }) => {
    ...
    return (
        <div className='hamburger-menu' style={hamburger ? {} : { transform: 'translateX(-125%)' }}>
            <div
